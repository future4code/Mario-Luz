...
var ProductDatabase = /** @class */ (function (_super) {
    ...
    ProductDatabase.prototype.toModel = function (dbModel) {
        return (dbModel &&
            new Product_1.Product(dbModel.id, dbModel.name, dbModel.price, dbModel.image_link));
    };
    ProductDatabase.prototype.create = function (product) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.setConnection()
                            .insert({
                            id: product.getId(),
    ...
    ProductDatabase.TABLE_NAME = 'Product';
